...
public class Test {
	...
	public static void main(String[] args) {
		...
		n1.add(new Note("aa", 15));
		n1.add(new Note("zz", 17.5f));
		n1.add(new Note("ee", 18));
		n1.add(new Note("ee", 10));

		ArrayList<Note> n2=new ArrayList<>();
		n2.add(new Note("aa", 11));
		n2.add(new Note("aa", 10));
		n2.add(new Note("aa", 12));
		n2.add(new Note("aa", 15.25f));
		
		Etudiant e1=new Etudiant("BB", "med", n1);
		Etudiant e2=new Etudiant("AA", "salah", n2);
		
		ArrayList<Etudiant> dsi2=new ArrayList<>();
		dsi2.add(e1);
		dsi2.add(e2);
		Stats s=new Stats(dsi2);
		System.out.println("Moyenne de l'etudiant e1:"+Stats.MoyenneEtudiant(e1));
